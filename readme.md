...
<p align="center"> 
  <samp>
    <br>
    「 Software Engineer from <b>Pakistan</b> 」
    <br>
    「 Django Python Developer | Next.js Full-Stack Developer | MERN Stack Learner 」
    <br>
...
- 🏢 **Experience**: 2 Web Development Internships at Devs-Space, Lahore
- 🌐 **Portfolio**: [portfolio-webpage-eight-ivory.vercel.app](https://portfolio-webpage-eight-ivory.vercel.app/)
...
**Devs-Space, Lahore** | *August 2024 - October 2024*
- Built web applications using **Django REST Framework** and integrated user features
- Developed robust backend APIs and implemented user authentication systems
- Collaborated with cross-functional teams to deliver scalable solutions

### Web Development Intern
**Devs-Space, Lahore** | *August 2023 - October 2023*
- Developed responsive web applications using **HTML, CSS, and JavaScript**
- Collaborated on front-end features and improved user experience
...
### 🏠 DARA - Property Rental Web Application
**Feb 2025 - Present** | **Django, Next.js, PostgreSQL**
- Full-stack property rental platform with comprehensive property listings
- Implemented user authentication, search functionality, and property management
- Built with modern tech stack ensuring scalability and performance
- **Features**: Property listing, advanced search, user profiles, booking system

### 💰 Finance Manager Web Application
**Nov 2024 - Dec 2024** | **Django, React**
- Comprehensive financial tracking and reporting tool
- Developed interactive dashboards with data visualizations
- Implemented budget tracking, expense categorization, and financial reporting
- **Features**: Transaction management, budget analysis, financial insights

### 🏢 Office Management Tool
**Aug 2024 - Sep 2024** | **Django REST Framework**
- Resource and task management system for office operations
- Automated workflows and improved operational efficiency
- Built RESTful APIs for seamless integration
- **Features**: Task assignment, resource allocation, workflow automation

---

## 🏆 Certifications

[![Python](https://img.shields.io/badge/Python-Certified-3776AB?style=for-the-badge&logo=python&logoColor=white)](https://drive.google.com/file/d/1w8RgrLI12ugdhUV1icgR_YiJ8M7UxEQT/view?usp=sharing)
[![WordPress](https://img.shields.io/badge/WordPress-Certified-21759B?style=for-the-badge&logo=wordpress&logoColor=white)](https://drive.google.com/file/d/11g28WIK3MZqDyJZM5iXnrwu2QaCxdtKW/view?usp=sharing)
[![Digital Marketing](https://img.shields.io/badge/Digital%20Marketing-Certified-FF6B6B?style=for-the-badge&logo=google&logoColor=white)](https://drive.google.com/file/d/1y9zwXa3cpW13uLFG-xHJ4F-M4xqpvxWg/view?usp=sharing)
[![SEO](https://img.shields.io/badge/SEO-Certified-4285F4?style=for-the-badge&logo=google&logoColor=white)](https://drive.google.com/file/d/1yFz0RvZx_TynQUs9t5NIUyH5lCIw0i2R/view?usp=sharing)

**Certified in:**
- **Python** - Simplilearn (July 2024)
- **WordPress** - DigiSkills.PK (March 2024)
- **Digital Marketing** - DigiSkills.PK (October 2024)
- **SEO** - DigiSkills.PK (October 2024)
...
- 🔨 **DARA Property Platform**: Expanding features and improving user experience
- 📚 **MERN Stack Mastery**: Building comprehensive full-stack applications
- 🌐 **Open Source Contributions**: Contributing to Django and React communities
- 📝 **Technical Writing**: Documenting best practices and sharing knowledge
- 🚀 **Career Growth**: Seeking full-time software engineering opportunities
...
<p align="center">
  ...
  <a href="mailto:hashirabdullah46@gmail.com">
    <img alt="Email" title="Email" src="https://img.shields.io/badge/-Email-EA4335?style=for-the-badge&logo=gmail&logoColor=white"/>
  </a>
</p>
